...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int userId) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(int userId)? data,
...
class _$Data with DiagnosticableTreeMixin implements Data {
  const _$Data({required this.userId});
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginState.data(userId: $userId)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'LoginState.data'))
...
abstract class Data implements LoginState {
  const factory Data({required final int userId}) = _$Data;
...
/// @nodoc
class __$$ErrorDetailsCopyWithImpl<$Res> extends _$LoginStateCopyWithImpl<$Res>
...
abstract class ErrorDetails implements LoginState {
